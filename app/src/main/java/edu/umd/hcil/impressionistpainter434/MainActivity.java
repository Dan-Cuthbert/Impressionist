...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menuCircle:
                Toast.makeText(this, "Flower Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.Flower);
                return true;
    ...
    /**
     * Saves an image from the ImpressionistView into the gallery
     *
     * @param v
     */
    ...
    /**
     * Toggles invert button
     *
     * @param v
     */
    public void toggleInvert(View v){
        _impressionistView.toggleInvert();
    }

    /**
     * Toggles Randomize button
     *
     * @param v
     */
    public void toggleRandom(View v){
        _impressionistView.toggleRandom();
    }
